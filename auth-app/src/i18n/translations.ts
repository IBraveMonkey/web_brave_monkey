...
export const en = {
  ...
  landing: {
    ...
    feature3Title: "Privacy",
    feature3Desc: "All data is processed locally on your device",
    ...
    benefit3: "Complete autonomy: Works locally with Docker backend",
    benefit4: "Maximum privacy: Data processing on your device",
  ...
  download: {
    title: "Download",
    subtitle:
      "Get the latest version of our application for your operating system",
    windows: "Windows",
    macos: "macOS",
...
export const ru = {
  ...
  landing: {
    ...
    feature3Desc: "Все данные обрабатываются локально на вашем устройстве",
    ...
    benefit3: "Полная автономность: Работает локально, с Docker-бэкендом",
    benefit4: "Максимальная приватность: Обработка данных на вашем устройстве",
  ...
  download: {
    title: "Скачать",
    subtitle:
      "Получите последнюю версию приложения для вашей операционной системы",
    windows: "Windows",
    macos: "macOS",
